            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="registrar.php" aria-current="page">Registrar-se</a>
            ...
            <div class="row">
                <div class="col-md-12 d-flex justify-content-center align-items-center ">
                    <div class="w-md-50 w-sm-100 mt-5 rounded-4">
                        ...
                        <form action="./funcs/registrar_post.php" class="" method="post">

                            <div class="text-center mb-5">
                                <h2 class="h1"><i class="bi bi-headset texto-laranja"></i></h2>
                                <h3>Helpdesk</h3>
                                <p class="fw-5">Para entrar faça o cadastro.</p>
                            </div>
